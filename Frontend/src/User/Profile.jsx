...
const Profile = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="min-h-screen bg-gray-50 flex flex-col items-center py-12 sm:py-6 lg:px-8 pt-24">
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-xl">
          <div className="bg-white py-10 px-6 shadow-md rounded-2xl sm:px-12 flex flex-col items-center border border-gray-100">
